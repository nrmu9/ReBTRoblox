...
// Ear (57) and eye (58) accessories were missing here, though the avatar has
// always known how to wear them, so hovering one gave up without trying.
export const WearableAssetTypeIds = [
	2, 8, 11, 12, 17, 18, 27, 28, 29, 30, 31, 41, 42, 43, 44, 45, 46, 47, 57, 58, 64, 65, 66, 67, 68, 69, 70,
	71, 72, 76, 77, 79,
]
